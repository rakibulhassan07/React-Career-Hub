...
import { getsStoredJobApplication } from "../../utility/localstorage";
...
const AppliedJobs = () => {
  ...
  useEffect(() => {
    const storedJobIds = getsStoredJobApplication();
    if (jobs.length > 0) {
      const jobApplied = [];
  ...
  return (
    <div>
      <h2 className="text-4xl text-center font-bold mb-10 ">Applied Jobs</h2>
